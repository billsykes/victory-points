...
3. **Set up repository secrets**
   ...
   - Add these secrets (the OAuth script will tell you the exact values):
     ...
     - `YAHOO_GUID`: Generated by the OAuth script (if available)
     - `YAHOO_TOKEN_TIME`: Generated by the OAuth script (if available)
     - `YAHOO_TOKEN_TYPE`: Generated by the OAuth script (if available)
